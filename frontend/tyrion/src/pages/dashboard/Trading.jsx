...
function Trading() {
  ...
  return (
    <div className="md:mt-[-80px] mt-[0] md:pr-[70px] w-[76%]">
      ...
      {/* upper flex */}
      <div className="flex items-center justify-between  md:mb-[101px] mb-[30px] text-xs md:text-xl ">
        <div className="">
          <h2 className=" font-medium text-[#FBC108DC]">Tyrion balance:</h2>
          <p className="font-bold "> 24,800 token</p>
        </div>
        <div>
          <h2 className=" font-medium text-[#FBC108DC] ">Naira balance:</h2>
          <p className="font-bold">N234,500</p>
        </div>
      </div>

      {/* bottom flex, flex col small screen */}
      <div className="flex flex-col-reverse md:flex-row md:justify-between md:mb-[21px] md:ml-[10px] md:mt-[-50px] mx-[54px] md:ml-0 ">
        {/* upper left flex */}
        <div>
        ...
        <div className="flex flex-col mb-[39px] md:mb-0 justify-self-end">
          ...
          <div className="flex flex-col">
            <p className="border-b border-[#FBC108DC] border-b-[1px] md:border-b-[3px] mb-[8px] md:mb-[15px] text-[10px] md:text-base ">
      ...
      <div>
        ...
        {transactionDetails.map((transaction) => (
          <div className="flex justify-between mb-[77px]">
            ...
            <div className="w-[200px] ">
              ...
              <h5 className="text-sm text-[#00000060] ">
                {transaction.mode.bank}
              </h5>
              <h5 className="text-sm text-[#00000060] ">
                {transaction.mode.acctNumber}
              </h5>
            </div>
            <div className="w-[200px] ">
